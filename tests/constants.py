...
NEXT_MORNING_TIME_FORMAT = "2024-03-01T06:00:00.000+0100"
NEXT_MORNING_TIME = datetime.fromisoformat(NEXT_MORNING_TIME_FORMAT)
...
ALL_NIGHTER_ACTIVITY = Activity(
    ...
    issue="ME-1",
    stints=(Stint(begin=DINNER_TIME),),
)

NIGHT_SHIFT_ACTIVITY = Activity(
    description="Debugging",
    issue="ME-1",
    stints=(Stint(begin=DINNER_TIME, end=NEXT_MORNING_TIME),),
)
